...
describe("bookings", () => {
  ...
  it("should allow to buy tickets for 4 passengers", async () => {
    const destination = "The Moon";
    const startDate = new Date(2022, 2, 22);
    const endDate = new Date(2022, 2, 28);
    const traveler = "Charles Tito";
  ...
  it("should allow to buy tickets for 5 passengers if the traveler is VIP", async () => {
    const destination = "The Moon";
    const startDate = new Date(2022, 2, 22);
    const endDate = new Date(2022, 2, 28);
    const traveler = "Charles Tito";
  ...
  it("should disallow to buy tickets for 7 passengers even if the traveler is VIP", async () => {
    const destination = "The Moon";
    const startDate = new Date(2022, 2, 22);
    const endDate = new Date(2022, 2, 28);
    const traveler = "Charles Tito";
  ...
  it("should save the booking for the agency own records", async () => {
    const destination = "The Moon";
    const startDate = new Date(2022, 2, 22);
    const endDate = new Date(2022, 2, 28);
    const traveler = "Charles Tito";
    const booking = await bookings.addBooking(destination, startDate, endDate, traveler);
    const savedBookingId = await bookings.save(booking);
    expect(savedBookingId).toBeGreaterThan(0);
  });
  it("should allow the traveler to pay its booking", async () => {
    const destination = "The Moon";
    const startDate = new Date(2022, 2, 22);
    const endDate = new Date(2022, 2, 28);
    const traveler = "Charles Tito";
    const booking = await bookings.addBooking(destination, startDate, endDate, traveler);
    booking.bookingId = (await bookings.save(booking)).toString();
  ...
  it("should send an email with booking and payment confirmation data to the traveler", async () => {
    const destination = "The Moon";
    const startDate = new Date(2022, 2, 22);
    const endDate = new Date(2022, 2, 28);
    const traveler = "Charles Tito";
  ...
  it("should notify paid bookings to the operator", async () => {
    const destination = "The Moon";
    const startDate = new Date(2022, 2, 22);
    const endDate = new Date(2022, 2, 28);
    const traveler = "Charles Tito";
  ...
  it("should not allow incomplete notification to the operator", async () => {
    const destination = "The Moon";
    const startDate = new Date(2022, 2, 22);
    const endDate = new Date(2022, 2, 28);
    const traveler = "Charles Tito";
  ...
  it("should get the booking price from the agency database", async () => {
    const destination = "The Moon";
